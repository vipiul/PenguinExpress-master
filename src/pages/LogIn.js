    ...
    <View style={{ flex: 1, }}>
      <ImageBackground style={{ height: '100%', width: '100%', }} source={require('../Images/LogInImage.png')}>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center',flex:1}}>
          <Text style={{ color: 'white', fontSize: 18, fontWeight: '500', marginVertical: 15 }}>Login to your Account </Text>
          <TextInput
          ...
          <TouchableOpacity style={{ height: 45, width: 90, backgroundColor: '#C32015', borderRadius: 20, marginVertical: 20, justifyContent: 'center' }}><Text style={{ color: 'white', fontSize: 16, textAlign: 'center' }} onPress={()=>props.navigation.navigate('Home')}>LogIn</Text></TouchableOpacity>
